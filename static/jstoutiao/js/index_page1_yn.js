                           ...
                           var arr=data.data.data,
                            ...
                            for(var i=0,len=arr.length;i<len;i++){
                                ...
                                if(arr[i].cityname.length === 3){
                                 ...
                                 else if(arr[i].cityname.length === 7){
                                    offsetStyle='sevenWord';
                                }
                                if(i < 12){
