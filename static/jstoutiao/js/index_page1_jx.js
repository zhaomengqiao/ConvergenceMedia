                    ...
                    success:function(data){
                        if(data.code === '200'){
                            ...
                            for(var i=0,len=arr.length;i<len;i++){
                                if(arr[i].cityname === '江西' || arr[i].cityname === '宿迁'){
                                    skipNum=skipNum+1;
                                    continue;
                                }
