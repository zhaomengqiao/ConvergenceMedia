    ...
    var weReadIndexIE8 = function() {
        var e = {
            ...
            setStyle: function() {
                ...
                $('#background').remove();
                $('#view').prepend('<img id="background_ie" src="images/background.png">');
            ...
            pngHack: function(){
                function f() {
                    ...
                    if ((u >=4.5) && (document.body.filters)) {
                        var s = 0;
      ...
      index = 0;
            ...
            setGlobal: function() {
                ...
                if (GLOBAL.DEVICE_TYPE){
                    ...
                    GLOBAL.HORIZONTAL_STYLE = aC < aD || innerHeight >1000;
                }
            },
            setStyle: function() {
            ...
            onresize: function() {
                ...
                if (GLOBAL.DEVICE_TYPE && !GLOBAL.HORIZONTAL_STYLE) {
                    ...
                    GLOBAL.HORIZONTAL_STYLE = aC < aD || innerHeight>1080;
                    weRead.checkPageSize();
                    if (!GLOBAL.HORIZONTAL_STYLE) {
            ...
            MobileEvent: function() {
                ...
                function aG(aI) {
                    ...
                    aC = aJ.pageY;
                    g.body.addEventListener('touchmove', aE,{ passive: false });
                }
                ...
                function aH(aI) {
                    var aJ = aI.targetTouches[0];
                    aD = aJ.pageX;
                    g.body.addEventListener('touchmove', aF,{ passive: false });
                }
...
//          W = g.getElementById('page_function4_table_face_05'),
        ...
        function aw() {
            ...
            function aI(){
                if (GLOBAL.DEVICE_TYPE === 1) {
                    if (ak.style.display === 'block' || !ak.style.display) {
                        aA(ak);
                        ak.style.display = 'block';
                        ak.classList.add('animateBaseIn');
                    }
                } else if (GLOBAL.DEVICE_TYPE === 2) {
                    if (aj.style.display === 'block' || !aj.style.display) {
                        aA(aj);
                        aj.style.display = 'block';
                        aj.classList.add('animateBaseIn');
                    }
                } else if (GLOBAL.DEVICE_TYPE === 0) {
                    if (al.style.display === 'block' || !al.style.display && ao != 0 && !GLOBAL.HORIZONTAL_STYLE) {
                        aA(al);
                        // al.style.transform = 'scale(1, 1)';
                        // al.style.webkitTransform = 'scale(1, 1)';
                        // al.style.display = 'block';
        ...
        function a(aC, aG, aD, aE){
            ...
            if (aE) {
                ...
                aC.addEventListener('webkit' + aG, aF, { passive: false });
                aC.addEventListener(aG.toLowerCase(), aF, { passive: false });
            } else {
                aC.addEventListener('webkit' + aG, aD, { passive: false });
                aC.addEventListener(aG.toLowerCase(), aD, { passive: false });
            }
        }
