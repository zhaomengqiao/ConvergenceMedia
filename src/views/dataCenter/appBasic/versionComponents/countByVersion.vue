...
<div>
    <el-form :inline="true" :model="form">
        <el-button @click="handleTopClick">按渠道</el-button>
        <el-button type="primary">按版本</el-button>
    ...
    <el-table ref="singleTable" class="table-total-count" :data="tableDataTotal" border style="width: 100%; margin-top: 10px;" :default-sort="{prop: 'date', order: 'descending'}" highlight-current-row @row-click="selectCurrent">
        ...
        <el-table-column width="100" label="版本名称" prop="appversion" align="center">
        </el-table-column>
        <!-- <el-table-column
              label="用户分布"
              align="center"
        ...
        <el-table-column label="新闻" align="center">
            <el-table-column prop="news_pv" label="pv" width="80" align="center" sortable>
            </el-table-column>
            <el-table-column prop="news_pvrate" label="pvrate" width="80" align="center" sortable :formatter="formatPercent">
            </el-table-column>
            <el-table-column prop="news_uv" label="uv" width="80" align="center" sortable>
            </el-table-column>
            <el-table-column prop="news_uvrate" label="uvrate" width="80" align="center" sortable :formatter="formatPercent">
            </el-table-column>
        </el-table-column>
        <el-table-column label="图集" align="center">
            <el-table-column prop="image_pv" label="pv" width="80" align="center" sortable>
            </el-table-column>
            <el-table-column prop="image_pvrate" label="pvrate" width="80" align="center" sortable :formatter="formatPercent">
            </el-table-column>
            <el-table-column prop="image_uv" label="uv" width="80" align="center" sortable>
            </el-table-column>
            <el-table-column prop="image_uvrate" label="uvrate" width="80" align="center" sortable :formatter="formatPercent">
            </el-table-column>
        </el-table-column>
        <el-table-column label="视频" align="center">
            <el-table-column prop="video_pv" label="pv" width="80" align="center" sortable>
            </el-table-column>
            <el-table-column prop="video_pvrate" label="pvrate" width="80" align="center" sortable :formatter="formatPercent">
            </el-table-column>
            <el-table-column prop="video_uv" label="uv" width="80" align="center" sortable>
            </el-table-column>
            <el-table-column prop="video_uvrate" label="uvrate" width="80" align="center" sortable :formatter="formatPercent">
            </el-table-column>
        </el-table-column>
        <el-table-column label="操作" align="center" width="80">
            <template slot-scope="scope">
                <el-button @click="handleQdHourVersion(scope.row)" type="text" size="middle">详情</el-button>
              </template>
        </el-table-column>
    </el-table>

    <el-table ref="singleTable" :data="tableData" border style="width: 100%; margin-top: 20px;" :default-sort="{prop: 'date', order: 'descending'}" highlight-current-row @row-click="selectCurrent">
        <el-table-column prop="dt" width="100" label="日期" align="center" sortable>
        </el-table-column>
        <el-table-column label="软件名称" align="center" width="100">
            <template slot-scope="scope">
                <el-button @click="handleQdSoftVersion(scope.row)" type="text" size="middle">{{ scope.row.apptype }}</el-button>
              </template>
        </el-table-column>
        <el-table-column width="100" label="版本名称" align="center">
            <template slot-scope="scope">
                <el-button @click="handleQdDetVersion(scope.row)" type="text" size="middle">{{ scope.row.appversion }}</el-button>
              </template>
        </el-table-column>
        <!-- <el-table-column
              label="用户分布"
...
export default {
    ...
    methods: {
        ...
        handleQdDetVersion: function(row) {
            this.$emit('comchange', 'dayQdDetVersion', row);
        },
        handleQdSoftVersion: function(row) {
            this.$emit('comchange', 'dayQdSoftVersion', row);
        },
        handleQdHourVersion: function(row) {
            this.$emit('comchange', 'dayQdHourVersion', row);
        },
        ...
        queryCreateList() {
            ...
            // jsonp回调函数
            window.appdayqdversion = function(data) {
                if (data.code === 200) {
                    data.datalist.forEach(function(item, index) {
                    ...
                    that.tableDataTotal[0].vf = '版本分布';
                    that.tableDataTotal[0].uf = '用户分布';
            ...
            jsonp('http://tongji.021.com/datacenterapi/appdayqd/appdayqdversion?callbackparam=appdayqdversion', {
                'param': queryParam,
                'name': 'callback'
            }, function(err, data) {
