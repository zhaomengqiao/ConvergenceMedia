...
<div>
    ...
    <el-table ref="singleTable" :data="tableData" border style="width: 100%; margin-top: 20px;" :default-sort="{prop: 'dt', order: 'ascending'}" highlight-current-row @row-click="selectCurrent">
        ...
        <el-table-column prop="appversion" width="100" label="版本名称" align="center">
        </el-table-column>
...
export default {
    ...
    methods: {
        ...
        queryCreateList() {
            ...
            // jsonp回调函数
            window.appdayqdfbverdet = function(data) {
                if (data.code === 200) {
                    data.datalist.forEach(function(item, index) {
            ...
            jsonp('http://tongji.021.com/datacenterapi/appdayqd/appdayqdfbverdet?callbackparam=appdayqdfbverdet', {
                'param': queryParam,
                'name': 'callback'
            }, function(err, data) {
