    ...
    <el-table :data="tableData2" class="roomList" highlight-current-row tooltip-effect="dark" stripe border align="center" v-loading="listLoading" :default-sort = "{prop: 'dt', order: 'descending'}" style="width: 100%">
        ...
        <el-table-column label="查看城市" align="center" sortable>
            <template slot-scope="scope">
                <el-button @click="qdClick(scope.row)" type="text" size="middle">查看</el-button>
            </template>
        </el-table-column>
    </el-table>
    <div class="block">
...
export default {
    ...
    methods: {
        ...
        qdClick: function(row) {
            this.$emit('qdchange', 'qidCity', row.qid);
        },
        ...
        getQid: function() {
            ...
            jsonp('http://tongji.021.com/datacenterapi/appqidareaspreaddata/getqid?callbackparam=sqid', null, function(err, data) {});
        },
        init() {
        ...
        queryCreateList() {
            ...
            jsonp('http://tongji.021.com/datacenterapi/appqidareaspreaddata/appqidareaspreadbyprovince?callbackparam=csdata', {
                'param': queryParam,
                'name': 'callback'
            }, function(err, data) {});
        }
