...
export default {
    ...
    methods: {
        ...
        getQid: function() {
            ...
            jsonp('http://tongji.021.com/datacenterapi/appqidareaspreaddata/getqid?callbackparam=checkqid', null, function(err, data) {});
        },
        init() {
        ...
        queryCreateList() {
            let that = this;
            // 参数字符串
            let queryParam = '&startDate=' + this.form.ctime + '&endDate=' + this.form.ctime + '&qid=' + this.form.qid + '&city=' + this.form.city + '&province=' + this.provname + '&apptypeid=' + this.form.apptypeid + '&callback';
            // jsonp回调函数
