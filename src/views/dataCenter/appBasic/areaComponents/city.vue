...
export default {
    ...
    methods: {
        ...
        getQid: function() {
            ...
            jsonp('http://tongji.021.com/datacenterapi/appqidareaspreaddata/getqid?callbackparam=cityqid', null, function(err, data) {});
        },
        init() {
