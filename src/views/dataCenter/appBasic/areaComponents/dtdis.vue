...
export default {
    ...
    methods: {
        cityClick: function(row) {
            this.$emit('citychange', 'lastBycity', row);
        },
        backClick: function() {
            this.$emit('backchange', 'ruanjian');
        },
        ...
        getQid: function() {
            ...
            jsonp('http://tongji.021.com/datacenterapi/appqidareaspreaddata/getqid?callbackparam=dtdisqid', null, function(err, data) {});
        },
        init() {
            this.getQid();
