...
export default {
    ...
    methods: {
        ...
        getQid: function() {
            ...
            jsonp('http://tongji.021.com/datacenterapi/appqidareaspreaddata/getqid?callbackparam=dayqid', null, function(err, data) {});
        },
        init() {
            console.log(this.provname);
            this.form.province = this.provname;
            this.getQid();
            this.form.qid = this.cqid;
        ...
        queryCreateList() {
            ...
            // 参数字符串
            let queryParam = '&startDate=' + this.form.stime + '&endDate=' + this.form.etime + '&qid=' + this.qid + '&city=' + this.city + '&province=' + this.provname + '&apptypeid=' + this.form.apptypeid + '&callback';
            // jsonp回调函数
