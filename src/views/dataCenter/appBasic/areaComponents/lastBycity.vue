...
export default {
    ...
    methods: {
        ...
        getQid: function() {
            // jsonp回调函数
            var that = this;
            window.lastBycityqid = function(data) {
                if (data.code === 200) {
            ...
            jsonp('http://tongji.021.com/datacenterapi/appqidareaspreaddata/getqid?callbackparam=lastBycityqid', null, function(err, data) {});
        },
        init() {
            this.queryCreateList();
            this.getQid();
