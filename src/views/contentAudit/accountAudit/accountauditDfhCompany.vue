    ...
    <section class="dfhPerson accountAuditTemp" v-loading="dialogLoading">
        ...
        <el-card class="box-card" :class="dialogData.isauditmodify=='2'?'mt-10':''">
            ...
            <el-row :gutter="40">
                ...
                <el-col :span="10">
                    <div class="clearfix">
                        ...
                        <div class="img-box">
                            ...
                            <div class="img-content">
                                <img :src="dialogData.professional" alt="" v-if="dialogData.professional">
                                <div class="img-box_tools" @click.stop="imgToBig(dialogData.professional,'text')">
                                    <i class="el-icon-zoom-in"></i>
                                </div>
                            </div>
                        </div>
                ...
                <el-col :span="6">
                    <div class="mb-10">
                        <el-radio-group v-model="dfhInforRadio" @change="changeReason">
                            <el-radio label="通过">通过</el-radio>
                            <el-radio label="拒绝">拒绝</el-radio>
                        </el-radio-group>
                    </div>
                    <el-select v-model="dfhInforReason" v-if="dfhInforRadio=='拒绝'" placeholder="请选择" filterable @change="changeReason" multiple>
                        <el-option-group
                            v-for="(group,index) in dfhInforSelections"
                            :key="index"
                            :label="group.label">
            ...
            <el-row :gutter="40">
                <el-col :span="8">
                    <div class="flex-box moreLong">
                        <div class="flex-label">企业名称</div>
                        <div class="flex-text">{{ dialogData.enterpriseName }}</div>
                    </div>
                    <div class="flex-box moreLong">
                        <div class="flex-label">营业执照号</div>
                        <div class="flex-text">{{ dialogData.entryType==2?dialogData.businessLicenseNum:dialogData.organizationNum }}</div>
                    </div>
                    <div class="flex-box moreLong">
                        <div class="flex-label">所在地</div>
                        <div class="flex-text">{{ dialogData.seatof }}</div>
                    ...
                    <div class="flex-box moreLong">
                        <div class="flex-label">网站</div>
                        <div class="flex-text">
                            <a :href="dialogData.website" class="aclick" target="_blank">{{ dialogData.website }}</a>
                        </div>
                    </div>
                </el-col>
                <el-col :span="10">
                    <div class="clearfix">
                        <div class="img-box">
                            ...
                            <div class="img-content" v-if='dialogData.entryType==2'>
                                <img :src="dialogData.businessLicense" alt="">
                                <div class="img-box_tools" @click.stop="imgToBig(dialogData.businessLicense,'infor')">
                                    <i class="el-icon-zoom-in"></i>
                                </div>
                            </div>
                            <div class="img-content" v-if='dialogData.entryType!=2'>
                ...
                <el-col :span="6">
                    <div class="mb-10">
                        <el-radio-group v-model="companyRadio" @change="changeReason">
                            <el-radio label="通过">通过</el-radio>
                            <el-radio label="拒绝">拒绝</el-radio>
                        </el-radio-group>
                    </div>
                    <el-select v-model="companyReason" v-if="companyRadio=='拒绝'" placeholder="请选择" filterable @change="changeReason" multiple>
                        <el-option-group
                            v-for="(group,index) in companySelections"
                            :key="index"
                            :label="group.label">
                            <el-option
                                v-for="(item,i) in group.options"
        ...
        <el-card class="box-card mt-10">
            ...
            <el-row :gutter="40">
                <el-col :span="18" class="clearfix"
                        v-if="dialogData.supportmaterials">
                    <div class="clearfix" :key="index" v-for="(item,index) in JSON.parse(dialogData.supportmaterials)">
                        <el-col :span="10">
                            <div class="info">
                                <div class="flex-box">
                                    <div class="flex-label">辅助材料{{ (index+1) }}</div>
                                    <div class="flex-text"></div>
                                </div>
                                <div class="flex-box">
                                    <div class="flex-label">平台名称</div>
                                    <div class="flex-text">{{ item.platform }}</div>
                                </div>
                                <div class="flex-box">
                                    <div class="flex-label">媒体名称</div>
                                    <div class="flex-text">{{ item.media }}</div>
                                </div>
                                <div class="flex-box">
                                    <div class="flex-label">主页链接</div>
                                    <div class="flex-text">
                                        <a :href="item.homePage" class="aclick" target="_blank">{{ item.homePage }}</a>
                                    </div>
                                </div>
                            </div>
                        </el-col>
                        <el-col :span="14">
                            <div class="article-img">
                                <img :src="item.articleImgFile" alt="">
                                <div class="img-box_tools" @click.stop="imgToBig(item.articleImgFile,'infor')">
                                    <i class="el-icon-zoom-in"></i>
                                </div>
                            </div>
                        </el-col>
                ...
                <el-col :span="18"v-if="!dialogData.supportmaterials">
                    <div style="font-size:24px;color:#999">暂无辅助材料</div>
                </el-col>
                <el-col :span="6">
                    <div class="mb-10">
                        <el-radio-group v-model="materialsRadio" @change="changeReason">
                            <el-radio label="通过">通过</el-radio>
                            <el-radio label="拒绝">拒绝</el-radio>
                        </el-radio-group>
                    </div>
                    <el-select v-model="materialsReason" placeholder="请选择" v-if="materialsRadio=='拒绝'" filterable @change="changeReason" multiple>
                        <el-option-group
                            v-for="(group,index) in materialsSelections"
                            :key="index"
                            :label="group.label">
                            <el-option
                                v-for="(item,i) in group.options"
        ...
        <el-dialog :visible.sync="imgScaleDialog" :modal="false" append-to-body :before-close="resetImg">
            <div class="dialog-img_wrap">
                ...
                <p v-if="dialogType=='text'">姓名：{{ dialogData.operatorName }}</p>
                <p v-if="dialogType=='text'">身份证：{{ dialogData.operatorId }}</p>
...
export default {
        ...
        return {
            ...
            companySelections: [
                ...
                },
                {
                    ...
                    options: [
                        {
                            label: '请提供正确的企业网址，若无企业网址可提供企业广告微博主页、其他平台的主页链接或文章链接。',
                            value: '请提供正确的企业网址，若无企业网址可提供企业广告微博主页、其他平台的主页链接或文章链接。'
                        }
                    ]
                },
                {
            ...
            materialsSelections: [
                {
                    ...
                    options: [
                        ...
                        {
                            label: '请提供所运营账号的后台文章列表截图，包含平台logo、作者自媒体名称及头像。具体内容可查看辅助材料图片上传处“查看图例"',
                            value: '请提供所运营账号的后台文章列表截图，包含平台logo、作者自媒体名称及头像。具体内容可查看辅助材料图片上传处“查看图例"'
                        },
                        {
                            label: '媒体名称与所提供的账号信息不一致。',
                            value: '媒体名称与所提供的账号信息不一致。'
                        },
                        {
                            label: '请提供正确的文章链接。',
                            value: '请提供正确的文章链接。'
                        ...
                        {
                            label: '所提供的辅助材料含有明显营销倾向。',
                            value: '所提供的辅助材料含有明显营销倾向。'
                        },
                        {
                            label: '请至少提供两个或以上的媒体平台运营资质。',
                            value: '请至少提供两个或以上的媒体平台运营资质。'
                        },
                        {
                            label: '请提供至少两项媒体名称与注册东方号名称一致的辅助材料信息',
                            value: '请提供至少两项媒体名称与注册东方号名称一致的辅助材料信息'
                        },
                        {
                            label: '抱歉！经评估，您的资质暂不符合平台内容生态需求，故不接受入驻，请努力提升创作水平！',
                            value: '抱歉！经评估，您的资质暂不符合平台内容生态需求，故不接受入驻，请努力提升创作水平！'
                        }
                    ]
                }
            ],
    ...
    methods: {
        ...
        changeReason(){
            if(this.dialogData.isauditmodify=='2'){
                if(this.modifyRadio === '通过' && this.dfhInforRadio === '通过' && this.operatorRadio === '通过' && this.materialsRadio === '通过' && this.companyRadio === '通过') {
                    this.isPass = 2
                    this.notification = '亲爱的创作者，你修改的信息已通过审核'
                }else {
                    this.isPass = 1
                    this.notification = ''
                    if(this.modifyRadio != '通过'){
                        this.notification += '修改信息：'
                    ...
                    if(this.companyRadio != '通过'){
                        this.notification += this.title + '：'
                        this.companyReason.forEach((item,index) => {
                            this.notification += (index+1) + '.' + item + '\n'
                        })
                    }
                    ...
                    if(this.materialsRadio != '通过'){
                        this.notification += '辅助材料：'
                        this.materialsReason.forEach((item,index) => {
                            this.notification += (index+1) + '.' + item + '\n'
                        })
                    }
                }
            }else{
                if(this.dfhInforRadio === '通过' && this.operatorRadio === '通过' && this.materialsRadio === '通过' && this.companyRadio === '通过') {
                    this.isPass = 2
                    ...
                    if(res.data === '0'){
                        ...
                        submitReview(params).then(res => {
                            if(res.code === '00001'){
                                ...
                                this.$emit('closeDialog','companyDialog')
                            }
                        })
                    }else{
                        this.$message({
    ...
    watch: {
        'dialogData': function(){
            ...
            this.operatorReason = []
            this.materialsRadio = '通过'
            this.materialsReason = []
            this.companyRadio = '通过'
            this.companyReason = []
        }
    }
}
