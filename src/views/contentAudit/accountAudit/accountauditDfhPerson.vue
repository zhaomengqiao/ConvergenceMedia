    ...
    methods: {
        ...
        changeReason(){
            if(this.dialogData.isauditmodify=='2'){
                // 修改
                // 选中通过后，理由自动过滤只剩通过
                if(this.modifyRadio === '通过' && this.dfhInforRadio === '通过' && this.operatorRadio=== '通过' && this.materialsRadio === '通过') {
                    this.isPass = 2
                ...
                // 新增
                // 选中通过后，理由自动过滤只剩通过
                if(this.dfhInforRadio === '通过' && this.operatorRadio=== '通过' && this.materialsRadio === '通过') {
                    this.isPass = 2
                    ...
                    if(res.data === '0'){
                        ...
                        submitReview(params).then(res => {
                            if(res.code === '00001'){
                                ...
                                this.$emit('closeDialog','personDialog')
                            }
                        })
                    }else {
                        this.$message({
