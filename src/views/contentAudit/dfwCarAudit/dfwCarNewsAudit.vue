...
<template>
<section class="new-dfwCar new-self">
    <!--新媒体新闻工具条-->
    <el-row :gutter="10" style="margin: 0 auto;min-width: 1100px;" v-loading="listLoading">
        ...
        <div class="next-title clearfix" style="height:49px;">
        ...
        <div class="self-content">
            <div class="list_div">
                ...
                <div class="list_li" style="border-bottom: 1px solid #bbbbbb;">
                    <el-select v-model="newExam.urlmaintype" popper-class='tfmaintypeSelect' :disabled="true" placeholder="请选择" style="width: 100%;float:left">
...
export default {
    ...
    data() {
        return {
            ...
            parentId: -1,
            newsType: 'eastdayqichenewsaudit',
            newNum: 0,
            newsSize: 5,
            newsRowkey: '',
            showKey: true,
    ...
    created() {
        ...
        this.getRedKeyWords();
        let wemedia_news = localStorage.getItem('eastdayqichenewsaudit');
        ...
        if (wemedia_news == null) {
            ...
            localStorage.setItem('eastdayqichenewsaudit', JSON.stringify(this.newExamList));
        }
    },
    mounted() {
        let _that = this;
    ...
    methods: {
        ...
        getAuth() {
            ...
            // 通过按钮权限
            if (authorList.indexOf('eastdayqichenewsaudit/audit-pass') > -1) {
                this.isAuth.newPassed = true;
            }
            // 拒绝按钮权限
            if (authorList.indexOf('eastdayqichenewsaudit/audit-refuse') > -1) {
        ...
        getNewExam() { //获取列表详情
            ...
            if (this.auditBegin) {
                getNewsCarExamList(para).then((res) => {
                    if (res.data != null) {
                        if (res.data != null) {
    ...
    destroyed() {
        ...
        localStorage.removeItem("eastdayqichenewsaudit")
        let para = {
            queue: 'eastdayqichenewsaudit'
        };
