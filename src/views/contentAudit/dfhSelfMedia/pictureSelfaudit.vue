            ...
            <el-row :gutter="4">
                ...
                <el-col :span="20" class="flex_center">
                    ...
                    <el-popover
                        ...
                        <span class="audit-title" slot="reference" v-html="newExam.contenttitle"></span>
                    </el-popover>
...
export default {
    ...
    methods: {
            ...
            if (this.auditBegin) {
                getPictureInfo(params).then(res => {
                    ...
                    if(this.dataList.length === 0){
                        ...
                        localStorage.setItem('selfmedia_img', JSON.stringify(this.dataList))
                        this.getCurrentImgs()
                    }
                })
            }
        ...
        // 获取本地数据
        getLocalData() {
            let localData = JSON.parse(localStorage.getItem('selfmedia_img'))
