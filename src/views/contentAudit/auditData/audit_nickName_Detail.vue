        ...
        <el-card class="mt-10">
            <el-row>
                <el-table :data="tableData"
                      ...
                      tooltip-effect="dark"
                      stripe border>
                      <el-table-column label="昵称" width="220" prop="createtime" :show-overflow-tooltip="true">
                          <template slot-scope="scope">
                              {{ scope.row.username.split('_')[0] }}
                          </template>
                      </el-table-column>
                      <el-table-column label="修改昵称" width="220" prop="createuser" :show-overflow-tooltip="true">
                          <template slot-scope="scope">
                              {{ scope.row.username.split('_')[0] }}
                          </template>
                      </el-table-column>
                      <el-table-column label="审核操作" min-width="220" prop="auditType" :show-overflow-tooltip="true">
                      </el-table-column>
                </el-table>
...
import {
    getNickNameAuditDetail,
    exportNickNameAuditDetail,
    getCommentDetailLog
} from '@/api/audit'
import {
    getAllAuditUser
...
export default {
    ...
    methods: {
        ...
        getList(){
            ...
            getNickNameAuditDetail(params).then(res => {
                if(res.code === '00001'){
        ...
        exportExcel(){
            var exportUrl = exportNickNameAuditDetail;
