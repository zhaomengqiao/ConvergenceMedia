        ...
        <el-table :data="tableData"
            ...
            <el-table-column prop="title" label="标题">
                <template slot-scope="scope">
                    ...
                    <span v-popover:popover1 style="white-space:nowrap" @click="showReplyForm(scope.row)" class="dialog-span" :class="scope.row.yzwbisban==1?'disable_title':''">{{ scope.row.title }}</span>
                </template>
            </el-table-column>
            ...
            <el-table-column label="操作" width="340" fixed="right">
                <template slot-scope="scope">
                    ...
                    <!-- <el-button type="warning" size="small"
                               ...
                               v-if="auth.toTop&&scope.row.yzwbblk==0&&scope.row.yzwbisban==0">置顶</el-button> -->
                               <el-button type="primary" size="small"
...
export default {
    ...
    methods: {
        ...
        getAuth() {
            ...
            if (authList.indexOf('content/black/yangzi/video') != -1) {
                this.auth.manage = true
            }
            if (authList.indexOf('video-platform-YANGZI') != -1) {
                this.auth.toTop = true
            }
            //视频编辑
            // if(authList.indexOf('sendvideo-platform-YANGZI') != -1){
            //     this.auth.edit = true
            // }
        },
        // 新闻主分类
